...
xcodebuild -target AFCache -sdk iphoneos3.2 "ARCHS=armv6 armv7" clean build
xcodebuild -target AFCache -sdk iphonesimulator3.2 "ARCHS=i386 x86_64" "VALID_ARCHS=i386 x86_64" clean build
